...
class FeedListViewController: UITableViewController, XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.backgroundColor = UIColorFromRGB(rgbValue: 0x7a9999)
    ...
    func loadData() {
        url = URL(string: "http://www.ziare.com/rss/12h.xml")!
        loadRss(url)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row % 2 == 0 {
            cell.backgroundColor = UIColorFromRGB(rgbValue: 0xdbe3e3)
            //cell.backgroundColor = UIColor(white: 1, alpha: 0.5)
        } else {
            cell.backgroundColor = UIColorFromRGB(rgbValue: 0xe3dbdb)
        }
        //print(myFeed)
        //print("\n\n\n")
        //print(feedImgs)
    ...
    // New Feeds functionalityblack
    func 

    // color = UIColor(red: 0xFF, green: 0xFF, blue: 0xFF)
    // color2 = UIColor(rgb: 0xFFFFFF)
